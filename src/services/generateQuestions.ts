...
export async function generateQuestions({ subject, reference, history, difficulty, exercisesNumber }: generateQuestionsParams): Promise<Exercises> {
    ...
    try {
        ...
        const remainingQuestions: Exercises = await generateQuestions({ subject, reference, history, difficulty, exercisesNumber: missingQuestions });
